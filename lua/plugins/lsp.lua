return {
  ...
  config = function()
    ...
    local servers = {
      -- Matches for the languages in plugins/treesitter.lua.
      bashls = {},
      clangd = {}, -- C
      marksman = {}, -- Markdown, including inline Markdown
      ts_query_ls = {},
      vimls = {},
      vimdoc_ls = {}, -- Vim help; installed separately below
      taplo = {}, -- TOML
      autotools_ls = { filetypes = { 'make', 'automake' } },
      cmake = {},
      texlab = {}, -- LaTeX and BibTeX
      tinymist = {}, -- Typst
      harper_ls = { filetypes = { 'gitcommit' } }, -- Commit spelling/grammar
      -- LuaDoc is handled by lua_ls within Lua files.
      -- No dedicated configs are listed for diff, regex, gitignore,
      -- git_config, or rasi; these retain Tree-sitter highlighting.
      ts_ls = {},
      ruff = {},
      pylsp = {
        settings = {
    ...
    -- vimdoc_ls is in nvim-lspconfig but not the Mason registry.
    -- Install it separately with: cargo install vimdoc-language-server
    local ensure_installed = vim.tbl_filter(function(server)
      return server ~= 'vimdoc_ls'
    ...
    for server, cfg in pairs(servers) do
      ...
      if server ~= 'vimdoc_ls' or vim.fn.executable('vimdoc-language-server') == 1 then
